#!/usr/bin/env python3
"""
Run a full end-to-end test of the Agentra agent orchestration.
...
# Get configuration
QUEUE_NAME = os.getenv('SQS_QUEUE_NAME', 'agentra-analysis-jobs')
...
def main():
    """Run the full test."""
    print("=" * 70)
    print(" Agentra Agent Orchestration - Full Test")
    print("=" * 70)
    ...
    if job.get('report_payload'):
        ...
        # Reporter writes content under 'content' key
        content = report.get('content') or report.get('analysis', '')
    ...
    if job.get('retirement_payload'):
        ...
        # Retirement agent writes markdown narrative under 'analysis' key
