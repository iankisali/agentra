...
TAGGER_FUNCTION = os.getenv("TAGGER_FUNCTION", "agentra-tagger")
REPORTER_FUNCTION = os.getenv("REPORTER_FUNCTION", "agentra-reporter")
CHARTER_FUNCTION = os.getenv("CHARTER_FUNCTION", "agentra-charter")
RETIREMENT_FUNCTION = os.getenv("RETIREMENT_FUNCTION", "agentra-retirement")
