#!/usr/bin/env python3
"""
Deploy the Agentra Financial Advisor Part 7 infrastructure.
This script:
...
def check_prerequisites():
    ...
    try:
        run_command(["aws", "sts", "get-caller-identity", "--profile", "ai"], capture_output=True)
...
def upload_frontend(bucket_name, cloudfront_id):
    ...
    run_command([
        ...
        "--cache-control", "max-age=0,no-cache,no-store,must-revalidate", "--profile", "ai"
    ])
    ...
    run_command([
        ...
        "--cache-control", "max-age=31536000,public", "--profile", "ai"
    ])
...
def main():
    ...
    print("🚀 Agentra Financial Advisor - Part 7 Deployment")
    print("=" * 50)
